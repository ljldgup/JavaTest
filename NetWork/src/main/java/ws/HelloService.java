 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/TomcatTest/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/TomcatTest/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "HelloPort"), Hello.class, features);
    }
