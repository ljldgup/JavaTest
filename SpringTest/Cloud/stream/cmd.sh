...
java -Xss108k -Xmx256m -Xmn80m -jar usage-detail-sender/target/*.jar --server.port=9001
java -Xss108k -Xmx256m -Xmn80m -jar usage-detail-sender/target/*.jar --server.port=9002
java -Xss108k -Xmx256m -Xmn80m -jar usage-cost-logger/target/*.jar --server.port=9003
